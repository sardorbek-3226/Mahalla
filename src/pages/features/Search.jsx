...
const Search = () => {
  ...
  return (
    <div>
      <PageHeader title="Qidiruv" subtitle="Usta, xizmat yoki kasb bo‘yicha qidiring" />
      ...
      {!q ? (
        <div>
          <p className="mb-3 text-center text-sm text-gray-400">Ommabop kategoriyalar</p>
        ...
        <EmptyState title="Hech narsa topilmadi" description={`"${q}" bo‘yicha natija yo‘q.`} />
      ) : (
